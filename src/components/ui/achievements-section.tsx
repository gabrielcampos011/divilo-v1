    ...
    return (
        <section>
            <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                <span className="bg-yellow-100 text-yellow-600 p-1 rounded-lg text-sm">🏆</span>
                Conquistas
            </h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {badges.map((badge) => (
                    ...
                    >
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-xl mb-3 ${badge.unlocked ? badge.color : "bg-gray-200 text-gray-400"}`}>
                            {badge.icon}
                        </div>
